...
- **NWS.zip**: 
    - This is basically a folder that contains WAV and TextGrid files, but in separate folders in a FastTracc-friendly manner. This is the folder structure required to extract vowels.
...
1. Download [**NWS_individual_vowels.zip**](https://github.com/TakayukiNagamine/FastTrack-Workshop/raw/main/zip/NWS_individual_vowels.zip) and save it somewhere on your computer.
