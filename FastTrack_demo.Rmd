...
```{r echo=FALSE, out.width="49%", out.height="20%", fig.show='hold', fig.cap='Setting window for formant estimation (left) and an example of comparison image (right)'}
